        ...
        >
          ...
          <div className="flex items-center">
            <datalist id="data">
              {" "}
              {COUNTRIES.map((item) => (
                <option key={`${item.mobileCode} ${item.name}`}>
                  {" "}
            ...
            <input
              ...
              className="border-2 border-slate-400 hover:border-slate-800 h-10 w-20 mr-2"
            />
            <input
              type="text"
              name="mobileNo"
              ...
              className="border-2 border-slate-400 hover:border-slate-800 h-10 w-48"
            />
          </div>
